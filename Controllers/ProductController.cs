...
namespace WebApi1WebAPI1.Controllers
{

    [EnableCors(origins:"*",headers:"*",methods:"*")]  //Enabling Cors for the whole controller
    public class ProductController : ApiController
    {
        ...
        /// <returns></returns>
        [HttpPost]
        public IHttpActionResult Add([FromBody]Product product)  //what is from body and uri
        {
